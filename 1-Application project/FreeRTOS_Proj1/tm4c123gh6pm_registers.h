...
/*****************************************************************************
ADC Registers (ADC0 - ADC1)
*****************************************************************************/

#define ADC0_ADCACTSS_REG          (*((volatile uint32 *)0x40038000))
#define ADC0_ADCEMUX_REG           (*((volatile uint32 *)0x40038014))
#define ADC0_ADCSSMUX0_REG         (*((volatile uint32 *)0x40038040))
#define ADC0_ADCSSCTL0_REG         (*((volatile uint32 *)0x40038044))
#define ADC0_ADCSSFIFO0_REG        (*((volatile uint32 *)0x40038048))
#define ADC0_ADCSSFSTAT0_REG       (*((volatile uint32 *)0x4003804C))
#define ADC0_ADCSSOP0_REG          (*((volatile uint32 *)0x40038050))
#define ADC0_ADCPSSI_REG           (*((volatile uint32 *)0x40038028))
#define ADC0_ADCIM_REG             (*((volatile uint32 *)0x40038008))
#define ADC0_ADCISC_REG            (*((volatile uint32 *)0x4003800C))
#define ADC0_ADCSSPRI_REG          (*((volatile uint32 *)0x40038020))

#define ADC1_ADCACTSS_REG          (*((volatile uint32 *)0x40039000))
#define ADC1_ADCEMUX_REG           (*((volatile uint32 *)0x40039014))
#define ADC1_ADCSSMUX0_REG         (*((volatile uint32 *)0x40039040))
#define ADC1_ADCSSCTL0_REG         (*((volatile uint32 *)0x40039044))
#define ADC1_ADCSSFIFO0_REG        (*((volatile uint32 *)0x40039048))
#define ADC1_ADCSSFSTAT0_REG       (*((volatile uint32 *)0x4003904C))
#define ADC1_ADCSSOP0_REG          (*((volatile uint32 *)0x40039050))
#define ADC1_ADCPSSI_REG           (*((volatile uint32 *)0x40039028))
#define ADC1_ADCIM_REG             (*((volatile uint32 *)0x40039008))
#define ADC1_ADCISC_REG            (*((volatile uint32 *)0x4003900C))
#define ADC1_ADCSSPRI_REG          (*((volatile uint32 *)0x40039020))
...
#define EEPROM_EERDWR_REG          (*((volatile uint32 *)0x400AF010))
